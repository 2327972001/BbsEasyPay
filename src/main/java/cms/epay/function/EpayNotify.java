...
/*
* @program: EpayNotify
* @description: 处理易支付接口通知返回
* @author: Mr.Zou
* @create: 2021-10-22 11:08
*/
public class EpayNotify {
	...
	public EpayNotify(EpayConfig_PC alipay_config) {
		this.epay_config = alipay_config;
	...
	public boolean getSignVeryfy(HashMap<String, String> para_temp, String sign) throws Exception {
		...
		isSgin = EpayMD5Function.md5Verify(prestr, sign, this.epay_config.getKey());
